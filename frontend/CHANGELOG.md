...
- **src/layouts/Admin.jsx** (instead of HomeTab)
- **src/layouts/RTL.jsx**
- **src/views/RTLPage/RTLPage.jsx**
### Deleted components
- **src/layouts/HomeTab/HomeTabsx** (renamed to Admin)
...
- Some components from `src/components/PhpTab` (instead of these we've added some css to style the normal HTML tags)
  - `src/components/PhpTab/A.jsx`
  - `src/components/PhpTab/P.jsx`
  - `src/components/PhpTab/Small.jsx`
...
## [1.2.0] 2018-04-16
### Bug Fixing
- Renamed `src/containers/App/App.jsx` to `src/layouts/HomeTab/HomeTab.jsx- Renamed `src/variables/styles.jsx` to `src/assets/jss/material-dashboard-react.jsx`
...
- Added design from Material HomeTab by Creative Tim
